...
= 多数のファイル出力を行うモデルでのデータ出力 (dc_date 版)
...
以下に示す ((<sp_topo_gtauto.f90|URL:gtauto_first/sp_topo_gtauto.f90>))
となります. 
...
による出力設定の変更を一通り試した後, 
((<使われているサブルーチンの説明|URL:gtauto_desc.htm>))
を参照してください. 
...
<font color="green"> 20</font>       program sp_topo_gtauto
...
<font color="green"> 49</font>         type(DC_DIFFTIME):: deltime, dispint           ! 時間間隔, 出力時間間隔
<font color="green"> 50</font>         type(DC_DIFFTIME):: endtime                    ! 計算終了時間
<font color="green"> 51</font>         type(DC_DIFFTIME):: ct                         ! 現在時刻
                         :
                         : 
...
<font color="green"> 77</font>         call DCDiffTimeCreate(deltime, dt, 'sec')      ! 時間間隔
<font color="green"> 78</font>         dispint = deltime * 500                        ! 出力時間間隔
<font color="green"> 79</font>         endtime = deltime * 10000                      ! 計算終了時間
<font color="green"> 80</font>         call DCDiffTimeCreate(ct,      0., 'sec')      ! 現在時刻     
...
<font color="green">113</font>            if ( mod(ct, dispint) == 0 ) then
<font color="green">114</font>              write(6,*) 'it = ', int( ct / deltime )
<font color="green">115</font>            end if
<font color="green">116</font>     
<font color="green">117</font>            ct = ct + deltime  ! 時刻の進行
...
<font color="green">202</font>       end program sp_topo_gtauto
</pre>
=end HTML
...
およびサンプルとして使用する NAMELIST ファイルを以下からダウンロードしてください. 
  ...
  * ((<sp_topo_gtauto.f90|URL:gtauto_first/sp_topo_gtauto.f90>))
...
<font color="green"> 49</font>         type(DC_DIFFTIME):: deltime, dispint           ! 時間間隔, 出力時間間隔
                         ...
                         : 
<font color="green"> 75</font>       !---- 時間積分パラメターの設定 ----
<font color="green"> 76</font>         dt = <b><font color="red">100.</font></b>                                      ! 時間間隔 [s]
<font color="green"> 77</font>         call DCDiffTimeCreate(deltime, dt, <b><font color="red">'sec'</font></b>)      ! 時間間隔
<font color="green"> 78</font>         dispint = deltime <b><font color="red">* 500</font></b>                        ! 出力時間間隔
                         :
                         : 
