...
! *** Caution!! ***
!
! This file is generated from "historygetattr.rb2f90" by Ruby 2.3.1.
...
! ※※※ 注意!!! ※※※
!
! このファイルは "historygetattr.rb2f90" から Ruby 2.3.1
! によって自動生成されたファイルです.
...
999 continue
  ...
  subroutine HistoryGettAttrInt1( &
    ...
    integer:: stat
    character(STRING):: cause_c
    character(len = *), parameter:: subname = "HistoryGetAttrInt1"
...
999 continue
  ...
  subroutine HistoryGettAttrReal1( &
    ...
    integer:: stat
    character(STRING):: cause_c
    character(len = *), parameter:: subname = "HistoryGetAttrReal1"
...
999 continue
  ...
  subroutine HistoryGettAttrDouble1( &
    ...
    integer:: stat
    character(STRING):: cause_c
    character(len = *), parameter:: subname = "HistoryGetAttrDouble1"
