!= gtool_historyauto  (dc_calendar 使用版) のテストプログラム (MPI 版)
!= Test program of "gtool_historyauto" with MPI (using dc_calendar)
!
! Authors::   Yasuhiro MORIKAWA
! Version::   $Id: histauto2_mpi.f90,v 1.4 2010-12-28 09:29:09 morikawa Exp $
! Tag Name::  $Name:  $
! Copyright:: Copyright (C) GFD Dennou Club, 2009. All rights reserved. 
! License::   See COPYRIGHT[link:../../COPYRIGHT]
!

program histauto2_mpi
...
100 continue
  ...
  inttime1 = DCCalConvertByUnit(   1.0_DP, 'hrs' , 'min' )
  endtime1 = DCCalConvertByUnit(   3.0_DP, 'hrs' , 'min' )
  ...
  call HistoryAutoCreate( &
    ...
    &  file_prefix = 'xhistauto2_mpi/test01-', &          ! (in) optional
...
200 continue
  ...
  call HistoryAutoCreate( &
    ...
    &       origin = time1, &                             ! (in) optional
    &     terminus = endtime1, &                          ! (in) optional
    &  file_prefix = 'xhistauto2_mpi/test02-', &           ! (in) optional
!!$    &  start_date = caldate1, &                           ! (in) optional
!!$    &         cal = cal1, &                               ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'sec'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test05-', &               ! (in) optional
...
!!$!  call HistoryAutoAddVariable( &
!!$!    & 'u1', (/'x   ', 'time'/), 'u1', 'm s-1', &  ! (in)
!!$!    & file = 'xhistauto2_mpi/test05-u.nc', &           ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'sec'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test06-', &               ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'sec'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test07-', &               ! (in) optional
...
!!$    & 'u1', (/'x   ', 'time'/), &       ! (in)
!!$    & 'u1', 'm s-1', &                  ! (in)
!!$    & file = 'xhistauto2_mpi/test07-u.nc', & ! (in) optional
...
!!$    & 'w1', (/'x   ', 'y   ', 'z   ', 'time'/), &    ! (in)
!!$    & 'w1', 'm s-1', &                               ! (in)
!!$    & file = 'xhistauto2_mpi/test07-w.nc', &              ! (in) optional
!!$    & slice_start  = (/  1,  1, 3 /), &              ! (in) optional
!!$    & slice_end    = (/ -1, -1, 6 /), &              ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'sec'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test08-', &               ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'min'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test09-', &               ! (in) optional
...
!!$!    & file = 'xhistauto2_mpi/test09-err.nc', &             ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'hrs'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test10-', &               ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'day'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test11-', &               ! (in) optional
...
!!$!    & 'err2', (/'z   ', 'time'/), &       ! (in)
!!$!    & 'err2', 'm s-1', &                  ! (in)
!!$!    & file = 'xhistauto2_mpi/test11-err.nc' )  ! (in) optional
!!$!
!!$!  call HistoryAutoAddVariable( &
!!$!    & 'err3', (/'z   ', 'time'/), &       ! (in)
!!$!    & 'err3', 'm s-1', &                  ! (in)
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'day'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test12-', &               ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'y   ', 'z   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'm  ',  'm  ',  'min'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test13-', &               ! (in) optional
...
!!$    & 'v', (/'y   ', 'time'/), &       ! (in)
!!$    & 'v', 'm s-1', &                  ! (in)
!!$    & file = 'xhistauto2_mpi/test13-v.nc' ) ! (in) optional
!!$
!!$  call HistoryAutoAddVariable( &
!!$    & 'w', (/'z   ', 'time'/), &       ! (in)
!!$    & 'w', 'm s-1', &                  ! (in)
...
!!$    &     units = (/ '1   ', '1   ', '1   ', '1   ', '1   ', &
!!$    &                '1   ', '1   ', '1   ', '1   ', 'sec ' /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test14-' )                ! (in) optional
!!$
!!$  call DCDiffTimeCreate( time1, &     ! (out)
!!$    & sec = 0.0_DP )                  ! (in)
!!$  call DCDiffTimeCreate( deltime1, &  ! (out)
...
!!$    & longnames = (/ 'x   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'min'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test15-01-', &            ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'time' /), & ! (in)
!!$    &     units = (/ 'm  ',  'day'  /), & ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test15-02-', &            ! (in) optional
!!$    &       origin =  time1, terminus = endtime1, &       ! (in) optional
!!$    &     interval =  inttime1, &                         ! (in) optional
!!$    &   all_output = .true., &                            ! (in) optional
...
!!$    &     interval =  inttime1, &                         ! (in) optional
!!$    &  file_prefix = 'xhistauto2_mpi/test16-' )                ! (in) optional
!!$
!!$  call HistoryAutoAddVariable( &
!!$    & 'u', (/'x   ', 'time'/), 'u', 'm s-1' ) ! (in)
!!$
...
!!$    &  file_prefix = 'xhistauto2_mpi/test17-' )                ! (in) optional
!!$
!!$  call HistoryAutoAddVariable( &
!!$    & 'u', (/'x   ', 'time'/), 'u', 'm s-1' ) ! (in)
!!$
...
!!$    &  file_prefix = 'xhistauto2_mpi/test18-' )          ! (in) optional
!!$
!!$  call HistoryAutoAddVariable( &
!!$    & 'u', (/'x   ', 'time'/), 'u', 'm s-1', &  ! (in)
...
!!$    & longnames = (/ 'x   ', 'time' /), &           ! (in)
!!$    &     units = (/ 'm  ', 'sec'  /), &            ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test19-none-', &    ! (in) optional
...
!!$    & longnames = (/ 'x   ', 'time' /), &           ! (in)
!!$    &     units = (/ 'm  ', 'sec'  /), &            ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test19-gregorian-', & ! (in) optional
!!$    &  origin_date = date1 )                          ! (in) optional
!!$
!!$  call HistoryAutoAddVariable( &
!!$    & 'u', (/'x   ', 'time'/), 'u', 'm s-1' ) ! (in)
...
!!$    & longnames = (/ 'x   ', 'time' /), &           ! (in)
!!$    &     units = (/ 'm  ', 'sec'  /), &            ! (in)
!!$    &  file_prefix = 'xhistauto2_mpi/test19-noleap-', &  ! (in) optional
!!$    &  origin_date = date1, &                       ! (in) optional
